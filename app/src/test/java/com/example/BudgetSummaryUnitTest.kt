...
class BudgetSummaryUnitTest {
    ...
    fun buildsSharedDailyWeeklyAndMonthlyTotals() {
        ...
        val expenses = listOf(
            ...
            Expense(amount = 700.0, currency = "INR", merchant = "Refund", category = "Other", dateInMillis = today.timeInMillis, originalSms = "Dear Customer, Acct XX070 is credited with Rs 700.00", transactionType = TransactionType.CREDIT.name, sourceSender = "AX-ICICIB"),
